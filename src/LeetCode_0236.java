...
public class LeetCode_0236 {
    ...
    public static void main(String[] args) {
        Integer[] rootArr = {3,5,1,6,2,0,8,null,null,7,4};
        Integer[] pArr = {5};
        Integer[] qArr = {1};
        TreeNode root = TreeNode.generateTreeNode(rootArr);
        TreeNode p = TreeNode.generateTreeNode(pArr);
        TreeNode q = TreeNode.generateTreeNode(qArr);
